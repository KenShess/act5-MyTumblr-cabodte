        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    ...
                    <div class="media-body mb-5 text-white">
                        <h4 class="mt-0 mb-0">Kenneth B. Cabodte</h4>
            ...
            <div class="bg-light p-4 d-flex justify-content-end text-center">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">6</h5><small class="text-muted"> <i class="fas fa-image mr-1"></i>Photos</small>
                    </li>
                    <li class="list-inline-item">
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    <p class="font-italic mb-0">Computer Literate</p>
                    <p class="font-italic mb-0">Network/Data Cabling Expert</p>
                    <p class="font-italic mb-0">Critical thinking and Problem solving</p>
                    <p class="font-italic mb-0">Photo Manipulation</p>
                </div>
            </div>

            <div class="py-4 px-4">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h5 class="mb-0">Recent Captures</h5><a href="photos.php" class="btn btn-link text-muted">Show all</a>
                </div>
                <div class="row">
